...
public class PayPalResult {
	...
	public String getAdderss_state() {
		return adderss_state;
	}
	
	public void setAdderss_state(String adderss_state) {
		this.adderss_state = adderss_state;
	}
